...
<body>
    ...
    <ul class="nav nav-pills">
        ...
        <li class="nav-item"><a class="nav-link" href="array.php">Simple Arrays and Printouts</a></li>
        ...
        <li class="nav-item"><a class="nav-link" href="ifstatement.php">Simple If-Else Statements</a></li>
        <li class="nav-item"><a class="nav-link" href="switchstatement.php">Simple Switch Statements</a></li>
